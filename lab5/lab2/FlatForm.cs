...
namespace lab2
{
    public partial class FlatForm : Form
    {
        ...
        private void buttonClearInfo_Click(object sender, EventArgs e)
        {
            ...
            radioButtonNotSalling.Checked = false;
            radioButtonSalling.Checked = false;
        ...
        {
          //  fathersFlat = new FathersFlat(fathersFlat);
           // MessageBox.Show(fathersFlat.FlatName);
         ...
         //   Flat flat = new Flat(footage, amountOfRooms, year, material, floor, kitchen, balcony, basement, livingRoom, bathroom, property, address);
            Flat repairingFlat = new Flat(footage, amountOfRooms, year, material, floor, kitchen, balcony, basement, livingRoom, bathroom, property, FlatState.salling, address);
            labelState.Text = repairingFlat.flatState.ToString();
        ...
        //    textBoxCost.Text = flat.CountCost().ToString();
            textBoxCost.Text = repairingFlat.CountCost().ToString();
            textBoxFlatInfo.Text = string.Empty;
        ...
        {
            labelState.Text = FlatState.repairing.ToString();
        }

        private void buttonRepair_Click(object sender, EventArgs e)
        {
            int repairType = comboBoxMaterial.SelectedIndex;
            switch (repairType)
            {
                case 0:
                    BrickRepair brickRepair = new BrickRepair();
                    brickRepair.Repair();
                    break;
                case 1:
                    WoodReapir woodRepair = new WoodReapir();
                    woodRepair.Repair();
                    break;
                case 2:
                    BlocksRepair blockRepair = new BlocksRepair();
                    blockRepair.Repair();
                    break;
                case 3:
                    PlatesRepair plateReapir = new PlatesRepair();
                    plateReapir.Repair();
                    break;
                default:
        ...
        private void radioButtonSalling_CheckedChanged(object sender, EventArgs e)
        {
            if (radioButtonSalling.Checked)
            {
                ...
                labelState.Text = FlatState.salling.ToString();
            }
        }
